        ...
        (function (data_1) {
            var BasicDataEnvironment = (function () {
                ...
                BasicDataEnvironment.prototype.deleteStructure = function (name) {
                    var tmp = (new Array());
                    for (var index29658 = 0; index29658 < BasicDataEnvironment.structures_$LI$().length; index29658++) {
                        var structure = BasicDataEnvironment.structures_$LI$()[index29658];
                        {
            ...
            (function (BasicDataEnvironment) {
                var BasicDataEnvironment$0 = (function () {
                    ...
                    BasicDataEnvironment$0.prototype.dataLoaded = function (data) {
                        ...
                        for (var index29659 = 0; index29659 < sobjects.length; index29659++) {
                            var o = sobjects[index29659];
                            {
        ...
        (function (data_2) {
            var DataService = (function () {
                ...
                DataService.prototype.create = function (type, fields, listener) {
                    var data = new Object();
                    {
                        var array29661 = fields.keySet();
                        for (var index29660 = 0; index29660 < array29661.length; index29660++) {
                            var key = array29661[index29660];
                            {
                ...
                DataService.prototype.update = function (type, objectId, fields, listener) {
                    var data = new Object();
                    {
                        var array29663 = fields.keySet();
                        for (var index29662 = 0; index29662 < array29663.length; index29662++) {
                            var key = array29663[index29662];
                            {
                                data[key] = fields.get(key);
                            }
                        }
        ...
        (function (data_3) {
            var File = (function () {
                ...
                File.prototype.getChild = function (name) {
                    {
                        var array29665 = this.getChildren();
                        for (var index29664 = 0; index29664 < array29665.length; index29664++) {
                            var f = array29665[index29664];
                            {
                ...
                File.prototype.removeFile = function (f) {
                    ...
                    {
                        var array29667 = this.file["children"];
                        for (var index29666 = 0; index29666 < array29667.length; index29666++) {
                            var o = array29667[index29666];
                            {
                                if (!(function (o1, o2) { if (o1 && o1.equals) {
                                    return o1.equals(o2);
                                }
                ...
                File.prototype.getChildren = function () {
                    ...
                    {
                        var array29669 = this.file["children"];
                        for (var index29668 = 0; index29668 < array29669.length; index29668++) {
                            var o = array29669[index29668];
                            {
        ...
        (function (libraries) {
            var AbstractComponentFactory = (function () {
                ...
                AbstractComponentFactory.prototype.configureStyles = function (instance, component) {
                    ...
                    for (var index29670 = 0; index29670 < keys.length; index29670++) {
                        var key = keys[index29670];
                        {
                ...
                AbstractComponentFactory.prototype.configureParameters = function (instance, component, designMode) {
                    ...
                    for (var index29671 = 0; index29671 < keys.length; index29671++) {
                        var key = keys[index29671];
                        {
                ...
                AbstractComponentFactory.prototype.configureEvents = function (instance, component) {
                    for (var index29672 = 0; index29672 < component.events.length; index29672++) {
                        var event_1 = component.events[index29672];
                        {
        ...
        (function (marshalling) {
            var MarshallUtil = (function () {
                ...
                MarshallUtil.extract = function (designable) {
                    ...
                    {
                        var array29674 = designable.getStyleNames();
                        for (var index29673 = 0; index29673 < array29674.length; index29673++) {
                            var s = array29674[index29673];
                            {
                                c.styles[s] = designable.getStyle(s);
                            }
                        }
                    }
                    for (var index29675 = 0; index29675 < parameters.length; index29675++) {
                        var p = parameters[index29675];
                        {
                            c.parameters[p.name] = p.extractValue(designable);
                        }
                    }
                    {
                        var array29677 = Object.keys(designable.getListeners());
                        for (var index29676 = 0; index29676 < array29677.length; index29676++) {
                            var key = array29677[index29676];
                            {
                                {
                                    var array29679 = designable.getListeners()[key];
                                    for (var index29678 = 0; index29678 < array29679.length; index29678++) {
                                        var l = array29679[index29678];
                                        {
                    ...
                    {
                        var array29681 = designable.getDesignables();
                        for (var index29680 = 0; index29680 < array29681.length; index29680++) {
                            var child = array29681[index29680];
                            {
                ...
                MarshallUtil.toDesignable = function (component) {
                    ...
                    if (component.children != null) {
                        for (var index29682 = 0; index29682 < component.children.length; index29682++) {
                            var c = component.children[index29682];
                            {
                ...
                MarshallUtil.controller = function (component, start) {
                    var des = framework.core.BeanFactory.getInstance().getBeanOfType("framework.builder.libraries.ComponentFactoryRegistry").getComponentFactory(component.impl).build(component, false);
                    des['setData$java_lang_Object'](component.data);
                    for (var index29683 = 0; index29683 < component.events.length; index29683++) {
                        var event_2 = component.events[index29683];
                        {
                            start = start + "\n" + des.getName() + ":function(source,event){\n" + event_2.source + "\n}";
                        }
                    }
                    if (component.children != null) {
                        for (var index29684 = 0; index29684 < component.children.length; index29684++) {
                            var c = component.children[index29684];
                            {
                ...
                MarshallUtil.toComponent$jsweet_lang_Object = function (o) {
                    ...
                    if (events != null && events.length > 0) {
                        ...
                        for (var index29685 = 0; index29685 < events.length; index29685++) {
                            var e = events[index29685];
                            {
                    ...
                    if (children != null && children.length > 0) {
                        for (var index29686 = 0; index29686 < children.length; index29686++) {
                            var c = children[index29686];
                            {
    ...
    (function (core) {
        var BeanFactory = (function () {
            ...
            BeanFactory.prototype.getBeanOfType = function (clazz) {
                {
                    var array29688 = Object.keys(this.beans);
                    for (var index29687 = 0; index29687 < array29688.length; index29687++) {
                        var key = array29688[index29687];
                        {
    ...
    (function (designables) {
        var DesignableDelegate = (function () {
            ...
            /*private*/ DesignableDelegate.prototype.containsName = function (name) {
                {
                    var array29690 = this.ui.getChildren();
                    for (var index29689 = 0; index29689 < array29690.length; index29689++) {
                        var c = array29690[index29689];
                        {
                            if ((function (o1, o2) { if (o1 && o1.equals) {
                                return o1.equals(o2);
                            }
...
(function (framework) {
    var ObjectBuilder = (function () {
        ...
        ObjectBuilder.prototype.clear = function () {
            {
                var array29692 = Object.keys(this.obj);
                for (var index29691 = 0; index29691 < array29692.length; index29691++) {
                    var s = array29692[index29691];
                    {
                        delete this.obj[s];
                    }
                }
    ...
    (function (renderer) {
        var ContainerRenderer = (function () {
            ...
            ContainerRenderer.prototype.renderEvents = function (njq, c) {
                ...
                for (var index29693 = 0; index29693 < keys.length; index29693++) {
                    var key = keys[index29693];
                    {
                        var listeners = c.getListeners()[key];
                        njq.addEventListener(key, (function (listeners) {
                            return function (evt) {
                                for (var index29694 = 0; index29694 < listeners.length; index29694++) {
                                    var l = listeners[index29694];
                                    {
            ...
            ContainerRenderer.prototype.synchronizeFields = function (njq, jsfield) {
                ...
                {
                    var array29696 = jsfield.getChildren();
                    for (var index29695 = 0; index29695 < array29696.length; index29695++) {
                        var c = array29696[index29695];
                        {
            ...
            ContainerRenderer.prototype.renderAttributes = function (njq, c, changed) {
                if (changed) {
                    {
                        var array29698 = c.getChangedAttributes();
                        for (var index29697 = 0; index29697 < array29698.length; index29697++) {
                            var key = array29698[index29697];
                            {
                    ...
                    {
                        var array29700 = c.getAttributeNames();
                        for (var index29699 = 0; index29699 < array29700.length; index29699++) {
                            var key = array29700[index29699];
                            {
                                if (c.getAttribute(key) != null)
                                    njq.setAttribute(key, c.getAttribute(key));
                            }
            ...
            ContainerRenderer.prototype.renderStyles = function (njq, c, changed) {
                if (changed) {
                    {
                        var array29702 = c.getChangedStyles();
                        for (var index29701 = 0; index29701 < array29702.length; index29701++) {
                            var key = array29702[index29701];
                            {
                    ...
                    {
                        var array29704 = c.getStyleNames();
                        for (var index29703 = 0; index29703 < array29704.length; index29703++) {
                            var key = array29704[index29703];
                            {
                                njq.style.setProperty(key, c.getStyle(key));
                            }
                        }
    ...
    (function (util) {
        var HashMap = (function () {
            ...
            HashMap.prototype.keySet = function () {
                var result = (new Array());
                {
                    var array29706 = Object.keys(this.d);
                    for (var index29705 = 0; index29705 < array29706.length; index29705++) {
                        var key = array29706[index29705];
                        {
                            result.push(key);
                        }
                    }
            ...
            var DataStructure = (function (_super) {
                ...
                DataStructure.prototype.getFields = function (source, listener) {
                    ...
                    if (cached == null) {
                        ...
                        for (var index29707 = 0; index29707 < cached.length; index29707++) {
                            var oField = cached[index29707];
                            {
            ...
            (function (DataStructure) {
                var DataStructure$0 = (function () {
                    ...
                    DataStructure$0.prototype.dataLoaded = function (data) {
                        ...
                        for (var index29708 = 0; index29708 < oFields.length; index29708++) {
                            var oField = oFields[index29708];
                            {
                                fields.push(new framework.builder.data.DataField(oField));
                            }
                        }
...
(function (framework) {
    var Boot = (function () {
        ...
        Boot.main = function (args) {
            ...
            for (var index29709 = 0; index29709 < tags.length; index29709++) {
                var tag = tags[index29709];
                {
            ...
            componentFactoryRegistry.registerComponentFactory("lgt:txt", new Boot.Boot$10("lgt:txt"));
            componentFactoryRegistry.registerComponentFactory("lgt:frm", new Boot.Boot$11("lgt:frm"));
            componentFactoryRegistry.registerComponentFactory("lgt:input", new Boot.Boot$12("lgt:input"));
            componentFactoryRegistry.registerComponentFactory("lgt:grid", new Boot.Boot$13("lgt:grid"));
            componentFactoryRegistry.registerComponentFactory("lgt:col", new Boot.Boot$14("lgt:col"));
            componentFactoryRegistry.registerComponentFactory("lgt:avatar", new Boot.Boot$15("lgt:avatar"));
            componentFactoryRegistry.registerComponentFactory("lgt:acc", new Boot.Boot$16("lgt:acc"));
            componentFactoryRegistry.registerComponentFactory("lgt:acc-item", new Boot.Boot$17("lgt:acc-item"));
            componentFactoryRegistry.registerComponentFactory("lgt:bcr", new Boot.Boot$18("lgt:bcr"));
            componentFactoryRegistry.registerComponentFactory("lgt:bcr-item", new Boot.Boot$19("lgt:bcr-item"));
            componentFactoryRegistry.registerComponentFactory("lgt:accitem", new Boot.Boot$20("lgt:accitem"));
            componentFactoryRegistry.registerComponentFactory("lgt:btn", new Boot.Boot$21("lgt:btn"));
            componentFactoryRegistry.registerComponentFactory("lgt:icon-btn", new Boot.Boot$22("lgt:icon-btn"));
            componentFactoryRegistry.registerComponentFactory("lgt:btn-grp", new Boot.Boot$23("lgt:btn-grp"));
            componentFactoryRegistry.registerComponentFactory("lgt:badge", new Boot.Boot$24("lgt:badge"));
            componentFactoryRegistry.registerComponentFactory("lgt:panel", new Boot.Boot$25("lgt:panel"));
            componentFactoryRegistry.registerComponentFactory("lgt:panel-section", new Boot.Boot$26("lgt:panel-section"));
            componentFactoryRegistry.registerComponentFactory("lgt:table", new Boot.Boot$27("lgt:table"));
    ...
    (function (Boot) {
        ...
        var Boot$11 = (function (_super) {
            ...
            Boot$11.prototype.createInstance = function (designMode) {
                var btn = new framework.lightning.designable.JSDesignableFormLayout();
                return btn;
            };
            return Boot$11;
        }(framework.builder.libraries.AbstractComponentFactory));
        ...
        var Boot$12 = (function (_super) {
            ...
            Boot$12.prototype.createInstance = function (designMode) {
                return new framework.lightning.designable.JSDesignableLightningInput("Input Element");
            };
            return Boot$12;
        }(framework.builder.libraries.AbstractComponentFactory));
        ...
        var Boot$13 = (function (_super) {
            ...
            Boot$13.prototype.createInstance = function (designMode) {
                return new framework.lightning.designable.JSDesignableLightningGrid("Grid");
            };
            return Boot$13;
        }(framework.builder.libraries.AbstractComponentFactory));
        ...
        var Boot$27 = (function (_super) {
            ...
            Boot$27.prototype.createInstance = function (designMode) {
                return new framework.lightning.designable.JSDesignableTable("Table");
            };
            return Boot$27;
        }(framework.builder.libraries.AbstractComponentFactory));
    ...
    (function (design) {
        var TagParameter = (function (_super) {
            ...
            TagParameter.prototype.getEditor = function (designable) {
                ...
                for (var index29710 = 0; index29710 < this.options.length; index29710++) {
                    var opt = this.options[index29710];
                    {
...
(function (framework) {
    ...
    var JSContainer = (function () {
        ...
        JSContainer.prototype.find = function (path) {
            ...
            for (var index29711 = 0; index29711 < sectins.length; index29711++) {
                var s = sectins[index29711];
                {
                    if ((function (o1, o2) { if (o1 && o1.equals) {
                        return o1.equals(o2);
                    }
        ...
        /*private*/ JSContainer.prototype.findDesignable = function (des, name, index) {
            ...
            {
                var array29713 = des.getDesignables();
                for (var index29712 = 0; index29712 < array29713.length; index29712++) {
                    var d = array29713[index29712];
                    {
                        if ((function (o1, o2) { if (o1 && o1.equals) {
                            return o1.equals(o2);
                        }
        ...
        JSContainer.prototype.getChild = function (name) {
            {
                var array29715 = this.getChildren();
                for (var index29714 = 0; index29714 < array29715.length; index29714++) {
                    var child = array29715[index29714];
                    {
                        if ((function (o1, o2) { if (o1 && o1.equals) {
                            return o1.equals(o2);
                        }
        ...
        JSContainer.prototype.addClass = function (styleClass) {
            ...
            var add = true;
            for (var index29716 = 0; index29716 < aStyles.length; index29716++) {
                var style = aStyles[index29716];
                {
                    if ((function (o1, o2) { if (o1 && o1.equals) {
                        return o1.equals(o2);
                    }
        ...
        JSContainer.prototype.addChildAt = function (index, child) {
            ...
            var i = 0;
            {
                var array29718 = this.getChildren();
                for (var index29717 = 0; index29717 < array29718.length; index29717++) {
                    var c = array29718[index29717];
                    {
                        if (i === index) {
                            children.push(c);
                        }
        ...
        JSContainer.prototype.setRendered = function (b) {
            ...
            if (!b) {
                {
                    var array29720 = this.getChildren();
                    for (var index29719 = 0; index29719 < array29720.length; index29719++) {
                        var child = array29720[index29719];
                        {
                            child.setRendered(b);
                        }
                    }
        ...
        JSContainer.prototype.contains = function (lst, o) {
            for (var index29721 = 0; index29721 < lst.length; index29721++) {
                var oo = lst[index29721];
                {
                    if ((function (o1, o2) { if (o1 && o1.equals) {
                        return o1.equals(o2);
                    }
        ...
        JSContainer.prototype.render$jsweet_dom_HTMLElement = function (parent) {
            ...
            if (!this.contains(renderers, JSContainer.defaultRenderer_$LI$())) {
                ...
                for (var index29722 = 0; index29722 < renderers.length; index29722++) {
                    var r = renderers[index29722];
                    {
                        tmp.push(r);
                    }
                }
            ...
            for (var index29723 = 0; index29723 < renderers.length; index29723++) {
                var renderer_1 = renderers[index29723];
                renderer_1.doRender(this, parent);
            }
            {
                var array29725 = this.getChildren();
                for (var index29724 = 0; index29724 < array29725.length; index29724++) {
                    var child = array29725[index29724];
                    {
                        child.render();
                    }
                }
            }
            for (var index29726 = 0; index29726 < renderers.length; index29726++) {
                var renderer_2 = renderers[index29726];
                {
        ...
        JSContainer.prototype.getAncestorWithClass = function (cls) {
            ...
            if (clsss != null) {
                {
                    var array29728 = parent.getAttribute("class").split(" ");
                    for (var index29727 = 0; index29727 < array29728.length; index29727++) {
                        var s = array29728[index29727];
                        {
                            if ((function (o1, o2) { if (o1 && o1.equals) {
                                return o1.equals(o2);
                            }
            ...
            var Structure = (function (_super) {
                ...
                Structure.prototype.reload$ = function () {
                    ...
                    for (var i = 0; i < items.length; i++) {
                        var li = new framework.JSContainer("li").setAttribute("role", "treeitem").setAttribute("aria-level", "0");
                ...
                Structure.prototype.getItem$framework_design_Designable$framework_JSContainer = function (designable, currentNode) {
                    {
                        var array29730 = currentNode.getChildren();
                        for (var index29729 = 0; index29729 < array29730.length; index29729++) {
                            var des = array29730[index29729];
                            {
                ...
                Structure.prototype.renderFiles = function () {
                    {
                        var array29732 = this.lis.keySet();
                        for (var index29731 = 0; index29731 < array29732.length; index29731++) {
                            var type = array29732[index29731];
                            {
                                ...
                                if (this.file.getChild(type) != null) {
                                    {
                                        var array29734 = this.file.getChild(type).getChildren();
                                        for (var index29733 = 0; index29733 < array29734.length; index29733++) {
                                            var f = array29734[index29733];
                                            {
                ...
                Structure.prototype.addNode = function (ctn, li, level, parent) {
                    ...
                    if (designables != null && designables.length > 0) {
                        ...
                        {
                            var array29736 = ctn.getDesignables();
                            for (var index29735 = 0; index29735 < array29736.length; index29735++) {
                                var c = array29736[index29735];
                                {
    ...
    (function (builder) {
        var FilesList = (function (_super) {
            ...
            FilesList.prototype.fireItemSelectedListeners = function (file, selector) {
                for (var index29737 = 0; index29737 < this.itemSelectedListeners.length; index29737++) {
                    var l = this.itemSelectedListeners[index29737];
                    {
            ...
            FilesList.prototype.select = function (file) {
                {
                    var array29739 = this.getChildren();
                    for (var index29738 = 0; index29738 < array29739.length; index29738++) {
                        var c = array29739[index29738];
                        {
                            if ((function (o1, o2) { if (o1 && o1.equals) {
                                return o1.equals(o2);
                            }
        ...
        var Previewer = (function (_super) {
            ...
            function Previewer(name) {
                ...
                websocket.onmessage = function (t) {
                    ...
                    {
                        var array29741 = f.getStylesheets();
                        for (var index29740 = 0; index29740 < array29741.length; index29740++) {
                            var sc = array29741[index29740];
                            {
                    ...
                    {
                        var array29743 = f.getScripts();
                        for (var index29742 = 0; index29742 < array29743.length; index29742++) {
                            var sc = array29743[index29742];
                            {
                    ...
                    {
                        var array29745 = f.getTemplates();
                        for (var index29744 = 0; index29744 < array29745.length; index29744++) {
                            var sc = array29745[index29744];
                            {
    ...
    (function (designables) {
        var JSDesignableList = (function (_super) {
            ...
            JSDesignableList.prototype.decorate = function () {
                ...
                if (dec != null) {
                    {
                        var array29747 = this.getChildren();
                        for (var index29746 = 0; index29746 < array29747.length; index29746++) {
                            var c = array29747[index29746];
                            {
                ...
                if (decStyle != null) {
                    {
                        var array29749 = this.getChildren();
                        for (var index29748 = 0; index29748 < array29749.length; index29748++) {
                            var c = array29749[index29748];
                            {
            ...
            JSDesignableList.prototype.removeDesignable = function (designable) {
                ...
                var tmp = (new Array());
                for (var index29750 = 0; index29750 < this.designables.length; index29750++) {
                    var d = this.designables[index29750];
                    {
                        if ((function (o1, o2) { if (o1 && o1.equals) {
                            return o1.equals(o2);
                        }
...
(function (framework) {
    var JSSelect = (function (_super) {
        ...
        JSSelect.prototype.getValue = function () {
            ...
            {
                var array29752 = this.getChildren();
                for (var index29751 = 0; index29751 < array29752.length; index29751++) {
                    var opt = array29752[index29751];
                    {
                        if ((function (o1, o2) { if (o1 && o1.equals) {
                            return o1.equals(o2);
                        }
        ...
        JSSelect.prototype.setValue$java_lang_String = function (val) {
            ...
            this.setAttribute("value", val);
            {
                var array29754 = this.getChildren();
                for (var index29753 = 0; index29753 < array29754.length; index29753++) {
                    var opt = array29754[index29753];
                    {
                        if ((function (o1, o2) { if (o1 && o1.equals) {
                            return o1.equals(o2);
                        }
    ...
    (function (lightning) {
        var Accordion = (function (_super) {
            ...
            Accordion.prototype.removeDesignable = function (designable) {
                var result = (new Array());
                for (var index29755 = 0; index29755 < this.designables.length; index29755++) {
                    var des = this.designables[index29755];
                    {
                        if ((function (o1, o2) { if (o1 && o1.equals) {
                            return o1.equals(o2);
                        }
    ...
    (function (lightning) {
        var Button = (function (_super) {
            ...
            Button.prototype.setState = function (state) {
                for (var index29756 = 0; index29756 < Button.states_$LI$().length; index29756++) {
                    var s = Button.states_$LI$()[index29756];
                    {
    ...
    (function (lightning) {
        var Col = (function (_super) {
            ...
            Col.prototype.refreshCls = function () {
                ...
                var ncls = "";
                for (var index29757 = 0; index29757 < cls.length; index29757++) {
                    var cl = cls[index29757];
                    {
                        if ((function (str, searchString, position) {
                            if (position === void 0) { position = 0; }
                            return str.substr(position, searchString.length) === searchString;
    ...
    (function (lightning) {
        var TabItem = (function (_super) {
            ...
            TabItem.prototype.fireClose = function () {
                for (var index29758 = 0; index29758 < this.listeners.length; index29758++) {
                    var li = this.listeners[index29758];
                    {
                        li.onClose(this);
                    }
                }
            ...
            TabItem.prototype.fireActivate = function () {
                for (var index29759 = 0; index29759 < this.listeners.length; index29759++) {
                    var li = this.listeners[index29759];
                    {
                        li.onActivate(this);
                    }
                }
            ...
            TabItem.prototype.fireDeActivate = function () {
                for (var index29760 = 0; index29760 < this.listeners.length; index29760++) {
                    var li = this.listeners[index29760];
                    {
        ...
        (function (table_3) {
            var Table = (function (_super) {
                ...
                function Table(name) {
                    ...
                    /*private*/ _this.rowsSelectionListeners = (new Array());
                    _this.model = null;
                ...
                Table.prototype.addRowsSelectionListener = function (l) {
                    this.rowsSelectionListeners.push(l);
                };
                Table.prototype.fireRowsSelectionListeners = function (source, evt, firstIndex, lastIndex) {
                    for (var index29761 = 0; index29761 < this.rowsSelectionListeners.length; index29761++) {
                        var l = this.rowsSelectionListeners[index29761];
                        {
    ...
    (function (lightning) {
        var Tabs = (function (_super) {
            ...
            Tabs.prototype.setActive = function (item) {
                {
                    var array29763 = this.getItems();
                    for (var index29762 = 0; index29762 < array29763.length; index29762++) {
                        var tab = array29763[index29762];
                        {
                            if ((function (o1, o2) { if (o1 && o1.equals) {
                                return o1.equals(o2);
                            }
            ...
            Tabs.prototype.getTab = function (body) {
                {
                    var array29765 = this.getItems();
                    for (var index29764 = 0; index29764 < array29765.length; index29764++) {
                        var c = array29765[index29764];
                        {
                            if ((function (o1, o2) { if (o1 && o1.equals) {
                                return o1.equals(o2);
                            }
            ...
            Tabs.prototype.getActiveTab = function () {
                {
                    var array29767 = this.getItems();
                    for (var index29766 = 0; index29766 < array29767.length; index29766++) {
                        var item = array29767[index29766];
                        {
                            if (item.isActive()) {
                                return item;
                            }
    ...
    (function (lightning) {
        var Text = (function (_super) {
            ...
            Text.prototype.setAlign = function (align) {
                for (var index29768 = 0; index29768 < Text.ALIGNS_$LI$().length; index29768++) {
                    var s = Text.ALIGNS_$LI$()[index29768];
                    {
                        this.removeClass(s);
                    }
                }
            ...
            Text.prototype.setTextType = function (type) {
                for (var index29769 = 0; index29769 < Text.TEXT_TYPES_$LI$().length; index29769++) {
                    var s = Text.TEXT_TYPES_$LI$()[index29769];
                    {
                        this.removeClass(s);
                    }
                }
            ...
            Text.prototype.setColor = function (color) {
                for (var index29770 = 0; index29770 < Text.COLORS_$LI$().length; index29770++) {
                    var s = Text.COLORS_$LI$()[index29770];
                    {
                        this.removeClass(s);
                    }
                }
            ...
            Text.prototype.setDecoration = function (decoration) {
                for (var index29771 = 0; index29771 < Text.DECORATIONS_$LI$().length; index29771++) {
                    var s = Text.DECORATIONS_$LI$()[index29771];
                    {
                        this.removeClass(s);
                    }
                }
            ...
            Text.prototype.getParameters = function () {
                ...
                var tagParam = new framework.design.TagParameter();
                {
                    var array29773 = Object.keys(Text.textTags_$LI$());
                    for (var index29772 = 0; index29772 < array29773.length; index29772++) {
                        var key = array29773[index29772];
                        {
        ...
        (function (data_7) {
            var DataSourcesEditor = (function (_super) {
                ...
                function DataSourcesEditor(name, rootEditor) {
                    ...
                    var form = new framework.lightning.FormLayout("form", "div");
        ...
        (function (editors) {
            var EventEditor = (function (_super) {
                ...
                function EventEditor(name, root, veditor) {
                    ...
                    _this.root = root;
                    for (var index29774 = 0; index29774 < framework.builder.editors.EventTypes.events_$LI$().length; index29774++) {
                        var s = framework.builder.editors.EventTypes.events_$LI$()[index29774];
                ...
                EventEditor.prototype.fillValue = function (des, updEvtSelect) {
                    ...
                    if (!updEvtSelect) {
                        ...
                        if (listeners != null) {
                            for (var index29775 = 0; index29775 < listeners.length; index29775++) {
                                var e = listeners[index29775];
                                {
                    ...
                    {
                        var array29777 = this.events.getChildren();
                        for (var index29776 = 0; index29776 < array29777.length; index29776++) {
                            var opt = array29777[index29776];
                            {
                                var option = opt;
                ...
                EventEditor.prototype.getSource = function (des, type) {
                    ...
                    if (listeners != null) {
                        for (var index29778 = 0; index29778 < listeners.length; index29778++) {
                            var l = listeners[index29778];
                            {
                                if (l != null && l instanceof framework.builder.BuilderEventListener) {
                                    var evt = l;
                ...
                /*private*/ EventEditor.prototype.findDesignableById = function (parent, id) {
                    ...
                    {
                        var array29780 = parent.getDesignables();
                        for (var index29779 = 0; index29779 < array29780.length; index29779++) {
                            var des = array29780[index29779];
                            {
                ...
                EventEditor.prototype.save$java_lang_String = function (type) {
                    ...
                    if (des != null) {
                        var listeners = des.getListeners()[type];
                        if (listeners != null) {
                            for (var index29781 = 0; index29781 < listeners.length; index29781++) {
                                var l_1 = listeners[index29781];
                                {
        ...
        (function (editors) {
            var VisualEditor = (function (_super) {
                ...
                function VisualEditor(name) {
                    ...
                    var frmjson = new framework.lightning.FormLayout("frmjson", "div");
                    ...
                    _this.jsonDef.getContent().addChild$framework_JSContainer(frmjson);
                ...
                VisualEditor.prototype.visit$framework_builder_editors_Visitor$framework_design_Designable = function (v, startAt) {
                    v.doVisit(startAt);
                    {
                        var array29783 = startAt.getDesignables();
                        for (var index29782 = 0; index29782 < array29783.length; index29782++) {
                            var child = array29783[index29782];
                            {
                ...
                VisualEditor.prototype.saveAsComponent = function (designable) {
                    var marshall = JSON.stringify(framework.builder.marshalling.MarshallUtil.extract(designable));
                    ...
                    project.createFile$framework_JSContainer$java_lang_String$java_lang_String$framework_builder_data_RemoteDataListener(this, name, "components", new VisualEditor.VisualEditor$3(this, marshall, designable));
                };
                ...
                VisualEditor.prototype.cona = function (component) {
                    ...
                    {
                        var array29785 = this.file.getTemplates();
                        for (var index29784 = 0; index29784 < array29785.length; index29784++) {
                            var temp = array29785[index29784];
                            {
                    ...
                    des['setData$java_lang_Object'](component.data);
                    if (component.children != null) {
                        for (var index29786 = 0; index29786 < component.children.length; index29786++) {
                            var c = component.children[index29786];
                            {
            ...
            (function (VisualEditor) {
                ...
                var VisualEditor$3 = (function () {
                    function VisualEditor$3(__parent, marshall, designable) {
                    ...
                    VisualEditor$3.prototype.dataLoaded = function (data) {
                        ...
                        framework.core.BeanFactory.getInstance().getBeanOfType("framework.builder.data.ProjectService").saveFile(this.designable, fff, new VisualEditor$3.VisualEditor$3$0(this));
                ...
                (function (VisualEditor$3) {
                    var VisualEditor$3$0 = (function () {
                        function VisualEditor$3$0(__parent) {
                            this.__parent = __parent;
                        }
                        /**
                         *
                         * @param {*} data
                         */
                        VisualEditor$3$0.prototype.dataLoaded = function (data) {
                            console.log(data);
                        };
                        return VisualEditor$3$0;
                    }());
                    VisualEditor$3.VisualEditor$3$0 = VisualEditor$3$0;
                    VisualEditor$3$0["__interfaces"] = ["framework.builder.data.RemoteDataListener"];
                })(VisualEditor$3 = VisualEditor.VisualEditor$3 || (VisualEditor.VisualEditor$3 = {}));
        ...
        var JSDesignableBuilderComponent = (function (_super) {
            ...
            JSDesignableBuilderComponent.prototype.applyParam = function (key, value) {
                ...
                if ((function (o1, o2) { if (o1 && o1.equals) {
                    ...
                    {
                        var array29788 = project.getChild("components").getChildren();
                        for (var index29787 = 0; index29787 < array29788.length; index29787++) {
                            var f = array29788[index29787];
                            {
                                if ((function (o1, o2) { if (o1 && o1.equals) {
                                    return o1.equals(o2);
                                }
                                    ...
                                    {
                                        var array29790 = f.getStylesheets();
                                        for (var index29789 = 0; index29789 < array29790.length; index29789++) {
                                            var sc = array29790[index29789];
                                            {
                                                var elem = document.createElement("style");
                                                elem.textContent = sc.getData();
                                                document.body.appendChild(elem);
                                    ...
                                    {
                                        var array29792 = f.getScripts();
                                        for (var index29791 = 0; index29791 < array29792.length; index29791++) {
                                            var sc = array29792[index29791];
                                            {
                                                var elem = document.createElement("script");
                                                elem.textContent = sc.getData();
                                                document.body.appendChild(elem);
                                    ...
                                    {
                                        var array29794 = f.getTemplates();
                                        for (var index29793 = 0; index29793 < array29794.length; index29793++) {
                                            var sc = array29794[index29793];
                                            {
                                                var elem = document.createElement("div");
            ...
            JSDesignableBuilderComponent.prototype.getParameters = function () {
                ...
                {
                    var array29796 = project.getChild("components").getChildren();
                    for (var index29795 = 0; index29795 < array29796.length; index29795++) {
                        var f = array29796[index29795];
                        {
...
(function (framework) {
    var JSHTMLFragment = (function (_super) {
        ...
        JSHTMLFragment.prototype.getParameters = function () {
            ...
            {
                var array29798 = project.getTemplates();
                for (var index29797 = 0; index29797 < array29798.length; index29797++) {
                    var f = array29798[index29797];
                    {
            ...
            (function (DataItem) {
                var DataItem$0 = (function () {
                    ...
                    DataItem$0.prototype.onSelectRow = function (source, event, table, firstIndex, lastIndex) {
                        var field = this.__parent.dataFields[firstIndex];
...
(function (framework) {
    ...
    (function (lightning) {
        var designable;
        (function (designable_1) {
            var JSDesignableLightningInput = (function (_super) {
                __extends(JSDesignableLightningInput, _super);
                function JSDesignableLightningInput(name) {
                    var _this = _super.call(this, name, "div") || this;
                    /*private*/ _this.delegate = new framework.designables.DesignableDelegate(_this);
                 ...
                 * @param {string} value
                 */
                JSDesignableLightningInput.prototype.applyParam = function (key, value) {
                    this.delegate.applyParameter(key, value, true);
                    if ((function (o1, o2) { return o1.toUpperCase() === (o2 === null ? o2 : o2.toUpperCase()); })(key, "type")) {
                        this.getInput().setType(value);
                    }
                    else if ((function (o1, o2) { if (o1 && o1.equals) {
                        return o1.equals(o2);
                    }
                 ...
                 * @return {*[]}
                 */
                JSDesignableLightningInput.prototype.getDesignables = function () {
                 ...
                 * @return {framework.builder.marshalling.Component}
                 */
                JSDesignableLightningInput.prototype.getComponent = function () {
                    return this.delegate.getComponent();
                };
                /**
                 *
                 * @return {framework.design.Parameter[]}
                 */
                JSDesignableLightningInput.prototype.getParameters = function () {
                    var parameters = this.delegate.getParameters();
                    var label = new framework.design.AttributeParameter("label", "Label", "Basic");
                 ...
                 * @param {*} designable
                 */
                JSDesignableLightningInput.prototype.addDesignable = function (designable) {
                 ...
                 * @param {*} designable
                 */
                JSDesignableLightningInput.prototype.removeDesignable = function (designable) {
                };
                /**
                 *
                 * @param {*} designable
                 * @param {number} steps
                 */
                JSDesignableLightningInput.prototype.moveDesignable = function (designable, steps) {
                };
                JSDesignableLightningInput.prototype.setDisabled = function (b) {
                    if (b) {
                ...
                return JSDesignableLightningInput;
            }(framework.lightning.FormElement));
            designable_1.JSDesignableLightningInput = JSDesignableLightningInput;
            JSDesignableLightningInput["__class"] = "framework.lightning.designable.JSDesignableLightningInput";
        ...
        })(designable = lightning.designable || (lightning.designable = {}));
    })(lightning = framework.lightning || (framework.lightning = {}));
})(framework || (framework = {}));
(function (framework) {
    var builder;
    (function (builder) {
        var Builder = (function (_super) {
            ...
            Builder.prototype.isOpen = function (editorName) {
                {
                    var array29800 = this.editorTabs.getItems();
                    for (var index29799 = 0; index29799 < array29800.length; index29799++) {
                        var item = array29800[index29799];
                        {
                            if ((function (o1, o2) { if (o1 && o1.equals) {
                                return o1.equals(o2);
                            }
            ...
            Builder.prototype.activateEditor = function (editorName) {
                {
                    var array29802 = this.editorTabs.getItems();
                    for (var index29801 = 0; index29801 < array29802.length; index29801++) {
                        var item = array29802[index29801];
                        {
                            if ((function (o1, o2) { if (o1 && o1.equals) {
                                return o1.equals(o2);
                            }
    ...
    (function (lightning) {
        var DescriptionList = (function (_super) {
            ...
            DescriptionList.prototype.setLayout = function (layout) {
                ...
                {
                    var array29804 = this.getChildren();
                    for (var index29803 = 0; index29803 < array29804.length; index29803++) {
                        var child = array29804[index29803];
                        {
            ...
            (function (ItemSelector) {
                var ItemSelector$0 = (function () {
                    ...
                    ItemSelector$0.prototype.onSelectRow = function (source, event, table, firstIndex, lastIndex) {
                        var field = this.__parent.dataList[firstIndex];
    ...
    (function (builder_1) {
        var WelcomeScreen = (function (_super) {
            ...
            function WelcomeScreen(name, builder) {
                ...
                for (var index29805 = 0; index29805 < items.length; index29805++) {
                    var item = items[index29805];
                    {
                        var li = new framework.JSContainer("li");
    ...
    (function (designables) {
        var JSDesignableTextComponent = (function (_super) {
            ...
            JSDesignableTextComponent.prototype.getParameters = function () {
                ...
                var tagParam = new framework.design.TagParameter();
                {
                    var array29807 = Object.keys(JSDesignableTextComponent.textTags_$LI$());
                    for (var index29806 = 0; index29806 < array29807.length; index29806++) {
                        var key = array29807[index29806];
                        {
            ...
            var StructureTreeItem = (function (_super) {
                ...
                /*private*/ StructureTreeItem.prototype.Move = function (clip, before) {
                    ...
                    if (parent != null) {
                        ...
                        for (var index29808 = 0; index29808 < children.length; index29808++) {
                            var child = children[index29808];
                            {
                        ...
                        var result = (new Array());
                        var cmp = framework.builder.marshalling.MarshallUtil.extract(clip);
                        var d = framework.builder.marshalling.MarshallUtil.toDesignable(cmp);
                        ...
                        ;
                        for (var index29809 = 0; index29809 < result.length; index29809++) {
                            var child = result[index29809];
                            {
                ...
                var StructureTreeItem$2 = (function () {
                    ...
                    StructureTreeItem$2.prototype.performAction = function (source, evt) {
                        if (this.__parent.parent != null) {
                            ...
                            this.__parent.structure.reload$framework_design_Designable(this.__parent.parent);
        ...
        (function (properties) {
            var AttributeWithOptionsEditor = (function (_super) {
                ...
                AttributeWithOptionsEditor.prototype.initEditor = function (designable, parameter) {
                    ...
                    this.clearChildren();
                    this.setRendered(false);
                    for (var index29810 = 0; index29810 < parameter.options.length; index29810++) {
                        var opt = parameter.options[index29810];
                        {
        ...
        (function (properties) {
            var OptionsEditor = (function (_super) {
                ...
                OptionsEditor.prototype.initEditor = function (designable, parameter) {
                    ...
                    {
                        var array29812 = select.getChildren();
                        for (var index29811 = 0; index29811 < array29812.length; index29811++) {
                            var c = array29812[index29811];
                            {
                                var opt = c;
                                value = value + "\n" + opt.getText();
                            }
                ...
                OptionsEditor.prototype.performAction = function (source, evt) {
                    ...
                    for (var index29813 = 0; index29813 < options.length; index29813++) {
                        var opt = options[index29813];
                        {
        ...
        (function (data) {
            var DynaForm = (function (_super) {
                ...
                DynaForm.prototype.setFields = function (fields) {
                    for (var index29814 = 0; index29814 < fields.length; index29814++) {
                        var o = fields[index29814];
                        {
                            var name_3 = o["name"];
                            var type = o["type"];
                            var label = o["label"];
                            var element = new framework.lightning.FormElement("elem_" + name_3, "div");
                            element.setLabel(label);
                            var input = new framework.JSInput(name_3);
                            if (type == null || (function (o1, o2) { return o1.toUpperCase() === (o2 === null ? o2 : o2.toUpperCase()); })(type.trim(), "") || (function (o1, o2) { return o1.toUpperCase() === (o2 === null ? o2 : o2.toUpperCase()); })(type, "string") || (function (o1, o2) { return o1.toUpperCase() === (o2 === null ? o2 : o2.toUpperCase()); })(type, "text")) {
                                ...
                                input = new framework.JSInput(name_3).setType(framework.InputTypes.number);
                            }
                            else if ((function (o1, o2) { return o1.toUpperCase() === (o2 === null ? o2 : o2.toUpperCase()); })(type, "select")) {
                                var options = o["options"];
                                var select = new framework.JSSelect(name_3);
                                for (var index29815 = 0; index29815 < options.length; index29815++) {
                                    var opt = options[index29815];
                                    {
                                        var text = opt["text"];
                                        var value = opt["value"];
                                ...
                                var multi = new framework.builder.data.MultiForm(name_3);
                                var options = o["options"];
                ...
                DynaForm.prototype.getValue = function () {
                    ...
                    {
                        var array29817 = this.getElements();
                        for (var index29816 = 0; index29816 < array29817.length; index29816++) {
                            var element = array29817[index29816];
                            {
                ...
                DynaForm.prototype.setValue$jsweet_lang_Object = function (val) {
                    {
                        var array29819 = this.getElements();
                        for (var index29818 = 0; index29818 < array29819.length; index29818++) {
                            var element = array29819[index29818];
                            {
                                var name_4 = element.getInput().getName();
                                if (val[name_4] != null) {
                                    var o = val[name_4];
                 ...
                 * @param {string} value
                 */
                DynaForm.prototype.setRawValue = function (value) {
                };
                return DynaForm;
    ...
    (function (lightning) {
        ...
        (function (designable_2) {
            var JSDesignableFormLayout = (function (_super) {
                 ...
                 * @return {*[]}
                 */
                JSDesignableFormLayout.prototype.getDesignables = function () {
                    var designable = (new Array());
                    {
                        var array29821 = this.getElements();
                        for (var index29820 = 0; index29820 < array29821.length; index29820++) {
                            var element = array29821[index29820];
                            {
                                if (element != null && element instanceof framework.lightning.designable.JSDesignableLightningInput)
                                    designable.push(element);
                                else
                                    designable.push(element.getInput());
                            }
                        }
                    }
                    return designable;
                 ...
                 * @return {framework.builder.marshalling.Component}
                 */
                JSDesignableFormLayout.prototype.getComponent = function () {
                    return this.delegate.getComponent();
                };
                /**
                 *
                ...
                JSDesignableFormLayout.prototype.addDesignable = function (designable) {
                    if (designable != null && designable instanceof framework.lightning.FormElement) {
                    ...
                    else if (designable != null && designable instanceof framework.JSInput) {
                        var element = new framework.lightning.designable.JSDesignableLightningInput(designable.getName());
                        designable.addClass("slds-input");
                        element.setInput(designable);
                        this.addFormElement(element);
                    }
                        ...
                        var element = new framework.lightning.FormElement(designable.getName(), "div");
                        element.setInput(designable);
                        this.addFormElement(element);
                    }
                    else {
                ...
                JSDesignableFormLayout.prototype.removeDesignable = function (designable) {
                    {
                        var array29823 = this.getElements();
                        for (var index29822 = 0; index29822 < array29823.length; index29822++) {
                            var element = array29823[index29822];
                            {
                                var b = (element != null && element instanceof framework.lightning.designable.JSDesignableLightningInput);
                                if (b) {
                                    if ((function (o1, o2) { if (o1 && o1.equals) {
                                        return o1.equals(o2);
                                    }
                ...
                JSDesignableFormLayout.prototype.moveDesignable = function (designable, steps) {
                    {
                        var array29825 = this.getElements();
                        for (var index29824 = 0; index29824 < array29825.length; index29824++) {
                            var element = array29825[index29824];
                            {
                                var b = (element != null && element instanceof framework.lightning.designable.JSDesignableLightningInput);
                                if (b) {
                                    if ((function (o1, o2) { if (o1 && o1.equals) {
            ...
            designable_2.JSDesignableFormLayout = JSDesignableFormLayout;
            JSDesignableFormLayout["__class"] = "framework.lightning.designable.JSDesignableFormLayout";
    ...
    (function (builder) {
        var ComponentsLibrary = (function (_super) {
            ...
            ComponentsLibrary.prototype.addComponents = function () {
                ...
                for (var index29826 = 0; index29826 < components.length; index29826++) {
                    var com = components[index29826];
                    {
...
(function (framework) {
    ...
    (function (lightning) {
        ...
        (function (designable_3) {
            ...
            designable_3.JSDesignableLightningGrid = JSDesignableLightningGrid;
            JSDesignableLightningGrid["__class"] = "framework.lightning.designable.JSDesignableLightningGrid";
    ...
    (function (builder_3) {
        var OpenProject = (function (_super) {
            ...
            OpenProject.prototype.dataLoaded$java_lang_Object = function (data) {
                var nprojects = data;
                for (var index29827 = 0; index29827 < nprojects.length; index29827++) {
                    var p = nprojects[index29827];
                    {
    ...
    (function (designables) {
        var JSDesignableLink = (function (_super) {
            ...
            JSDesignableLink.prototype.getParameters = function () {
                var parameters = _super.prototype.getParameters.call(this);
                var result = (new Array());
                for (var index29828 = 0; index29828 < parameters.length; index29828++) {
                    var p = parameters[index29828];
                    {
        ...
        (function (properties) {
            var AdvancedPropertiesEditor = (function (_super) {
                ...
                AdvancedPropertiesEditor.prototype.setComponent = function (designable) {
                    ...
                    this.clear();
                    {
                        var array29830 = this.component.getParameters();
                        for (var index29829 = 0; index29829 < array29830.length; index29829++) {
                            var p = array29830[index29829];
                            {
        ...
        (function (properties) {
            var BasicPropertiesEditor = (function (_super) {
                ...
                BasicPropertiesEditor.prototype.setComponent = function (designable) {
                    ...
                    this.clear();
                    {
                        var array29832 = designable.getParameters();
                        for (var index29831 = 0; index29831 < array29832.length; index29831++) {
                            var param = array29832[index29831];
                            {
                                if ((function (o1, o2) { if (o1 && o1.equals) {
                                    return o1.equals(o2);
                                }
            ...
            JSDesignableSelect.prototype.applyParam = function (key, value) {
                ...
                if ((function (o1, o2) { if (o1 && o1.equals) {
                    ...
                    if (value != null) {
                        ...
                        this.setRendered(false);
                        {
                            var array29834 = Object.keys(o);
                            for (var index29833 = 0; index29833 < array29834.length; index29833++) {
                                var val = array29834[index29833];
                                {
                                    var txt = o[val];
        ...
        (function (designable_4) {
            var JSDesignableTable = (function (_super) {
                ...
                JSDesignableTable.prototype.applyParam = function (key, value) {
                    ...
                    if ((function (o1, o2) { if (o1 && o1.equals) {
                        ...
                        if (value != null) {
                            var o = JSON.parse(value);
                            {
                                var array29836 = Object.keys(o);
                                for (var index29835 = 0; index29835 < array29836.length; index29835++) {
                                    var val = array29836[index29835];
                                    {
                                        var txt = o[val];
                ...
                JSDesignableTable.prototype.getParameters = function () {
                    ...
                    for (var index29837 = 0; index29837 < boolParams.length; index29837++) {
                        var param = boolParams[index29837];
                        {
            ...
            designable_4.JSDesignableTable = JSDesignableTable;
            JSDesignableTable["__class"] = "framework.lightning.designable.JSDesignableTable";
            JSDesignableTable["__interfaces"] = ["framework.lightning.table.TableModel", "framework.interactions.Droppable", "framework.lightning.table.TableColumnModel", "framework.design.Designable", "framework.design.ExtDesignable", "framework.Renderable"];
            ...
            })(JSDesignableTable = designable_4.JSDesignableTable || (designable_4.JSDesignableTable = {}));
        })(designable = lightning.designable || (lightning.designable = {}));
    })(lightning = framework.lightning || (framework.lightning = {}));
})(framework || (framework = {}));
(function (framework) {
        ...
        (function (libraries) {
            var LibrariesDockedComposer = (function (_super) {
                ...
                LibrariesDockedComposer.prototype.refreshWithProject = function (des) {
                    ...
                    {
                        var array29839 = Object.keys(customs);
                        for (var index29838 = 0; index29838 < array29839.length; index29838++) {
                            var s = array29839[index29838];
                            {
        ...
        (function (properties) {
            var PropertiesDockedComposer = (function (_super) {
                ...
                PropertiesDockedComposer.prototype.selectComponent = function (designable) {
                    ...
                    this.mainEditor.addItem$java_lang_String$framework_builder_properties_PropertiesEditor("Advanced", advancedPropertiesEditorBody);
                    ...
                    if (designable != null && (designable["__interfaces"] != null && designable["__interfaces"].indexOf("framework.design.ExtDesignable") >= 0 || designable.constructor != null && designable.constructor["__interfaces"] != null && designable.constructor["__interfaces"].indexOf("framework.design.ExtDesignable") >= 0)) {
                        ...
                        if (editors_1 != null && editors_1.length > 0) {
                            for (var index29840 = 0; index29840 < editors_1.length; index29840++) {
                                var e = editors_1[index29840];
                                {
        ...
        (function (data_9) {
            var CrudTable = (function (_super) {
                ...
                CrudTable.prototype.setFields = function (fields) {
                    ...
                    for (var index29841 = 0; index29841 < fields.length; index29841++) {
                        var field = fields[index29841];
                        {
        ...
        (function (data) {
            var MultiForm = (function (_super) {
                ...
                MultiForm.prototype.setConfigs = function (fields) {
                    var count = 0;
                    for (var index29842 = 0; index29842 < fields.length; index29842++) {
                        var opt = fields[index29842];
                        {
                            var name_6 = opt["name"];
                            var label = opt["label"];
                ...
                MultiForm.prototype.getValue = function () {
                    ...
                    result["type"] = type;
                    {
                        var array29844 = this.map.keySet();
                        for (var index29843 = 0; index29843 < array29844.length; index29843++) {
                            var name_7 = array29844[index29843];
                            {
                                if ((function (o1, o2) { if (o1 && o1.equals) {
                                    return o1.equals(o2);
                                }
                ...
                MultiForm.prototype.setValue$jsweet_lang_Object = function (val) {
                    {
                        var array29846 = this.map.keySet();
                        for (var index29845 = 0; index29845 < array29846.length; index29845++) {
                            var name_8 = array29846[index29845];
                            {
                                if (val[name_8] != null) {
                    ...
                    {
                        var array29848 = this.map.keySet();
                        for (var index29847 = 0; index29847 < array29848.length; index29847++) {
                            var name_9 = array29848[index29847];
                            {
                 ...
                 * @param {string} value
                 */
                MultiForm.prototype.setRawValue = function (value) {
                };
                return MultiForm;
            }(framework.lightning.Panel));
            ...
            (function (MultiForm) {
                var MultiForm$0 = (function () {
                    ...
                    MultiForm$0.prototype.performAction = function (source, evt) {
                        ...
                        {
                            var array29850 = this.__parent.map.keySet();
                            for (var index29849 = 0; index29849 < array29850.length; index29849++) {
                                var name_10 = array29850[index29849];
                                {
